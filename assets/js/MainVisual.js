(function () {
  ...
  sample.MainVisual.prototype.createDatGUIBox = function () {
    ...
    controler1.onChange(function (value) {
      self.Triangles.setUniform('animationValue1', value);
    });
    controler2.onChange(function (value) {
      self.Triangles.setUniform('animationValue2', value);
    });
    controler3.onChange(function (value) {
      self.Triangles.setUniform('animationValue3', value);
    });
    controler4.onChange(function (value) {
      self.Triangles.setUniform('animationValue4', value);
    });
    controler5.onChange(function (value) {
      self.Triangles.setUniform('animationValue5', value);
    });
    controler6.onChange(function (value) {
      self.Triangles.setUniform('animationValue6', value);
    });
    controler7.onChange(function (value) {
      self.Triangles.setUniform('animationValue7', value);
    });
    controler8.onChange(function (value) {
      self.Triangles.setUniform('animationValue8', value);
    });
  }
